package com.example.tatneft_quest.libs;
...
public class ImprovedPreference {
    ...
    public ImprovedPreference(Context appContext) {
    ...
    public ArrayList<ClusterMarkerPoints> getListObject(String key, Class<?> mClass) {
        ...
        ArrayList<ClusterMarkerPoints> objects = new ArrayList<ClusterMarkerPoints>();
